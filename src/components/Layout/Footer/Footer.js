...
<footer className="bg-black dark:bg-gray-300 pt-4 pb-8 xl:pt-8">
    <div className="max-w-screen-lg xl:max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 text-gray-400 dark:text-gray-300">
        <ul className="text-lg font-light pb-8 flex flex-wrap justify-center">
            <li className="w-1/2 md:w-1/3 lg:w-1/3">
                <div className="text-center">
                    <h2 className="text-gray-100 dark:text-gray-200 text-md uppercase mb-4">
                        Components
                    </h2>
                    <ul>
                        <li className="mb-4 hover:text-gray-300 dark:hover:text-white transition-colors duration-200">
                            <a href="/">
                                Admin
                            </a>
                        </li>
        ...
        <div className="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
            <a href="/">
                <svg width="20" height="20" fill="currentColor" className="text-xl hover:text-gray-300 dark:hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-xl hover:text-gray-300 dark:hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792">
